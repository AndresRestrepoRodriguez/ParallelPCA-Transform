...
nb_1, nb_2, nb_3 = componentes_principales_panchromartic(p1, pc_2, pc_3, inv_eigenvectors)
...
# Se guarda la imagen en una direccion especifica con el noimbre del tercer parametro de ejecucion
t = skimage.io.imsave('/home/nvera/andres/pca/'+output_fus+'.tif',fusioned_image, plugin='tifffile')

#Tiempo de ejecucin para la transformada mediante PCA en GPU
tiempo = (end-start)
